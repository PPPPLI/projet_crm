...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		Phase&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <!--list the stageList,display on each icon-->
        <c:forEach items="${stageList}" var="stage">
            <!--if stage is actuel stage，icon is map-marker，color is green-->
            ...
            <!--if stage is previous stage，icon is ok-circle，color is green-->
            ...
            <!--if stage is next stage，icon is record，color is black-->
            <c:if test="${tran.orderNo<stage.orderNo}">
	...
	<div style="position: relative; top: 0px;">
		<div style="position: relative; left: 40px; height: 30px;">
			...
			<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">Amount</div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 20px;">
			...
			<div style="width: 300px;position: relative; left: 450px; top: -40px; color: gray;">Phase</div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 50px;">
			<div style="width: 300px; color: gray;">Contact</div>
        ...
        <c:forEach items="${remarkList}" var="remark">
            <div class="remarkDiv" id="div_${remark.id}" style="height: 60px;">
                ...
                <div style="position: relative; top: -40px; left: 40px;" >
                    ...
                    <font color="gray">交易</font> <font color="gray">-</font> <b>${tran.name}</b> <small style="color: gray;"> ${remark.editFlag=='0'?remark.createTime:remark.editTime} 由${remark.editFlag=='0'?remark.creayeBy:remark.editBy}${remark.editFlag=='0'?'Create':'Edit'}</small>
